...
import { IMAGE_SHADOW_PRESETS } from '../../constants';

interface ImageShadowPresetButtonProps {
  preset: (typeof IMAGE_SHADOW_PRESETS)[number];
  isSelected: boolean;
  onClick: () => void;
}

export const ImageShadowPresetButton: React.FC<ImageShadowPresetButtonProps> = ({
  preset,
  isSelected,
  onClick,
}) => {
...
export default ImageShadowPresetButton;
